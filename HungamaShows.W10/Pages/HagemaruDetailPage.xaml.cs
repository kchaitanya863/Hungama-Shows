//---------------------------------------------------------------------------
//
// <copyright file="HagemaruDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class HagemaruDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public HagemaruDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new HagemaruSection());
