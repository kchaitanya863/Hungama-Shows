//---------------------------------------------------------------------------
//
// <copyright file="ChhotaBheemDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ChhotaBheemDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ChhotaBheemDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new ChhotaBheemSection());
