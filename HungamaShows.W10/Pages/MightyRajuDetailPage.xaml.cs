//---------------------------------------------------------------------------
//
// <copyright file="MightyRajuDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class MightyRajuDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public MightyRajuDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new MightyRajuSection());
