//---------------------------------------------------------------------------
//
// <copyright file="ShinchanDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class ShinchanDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public ShinchanDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new ShinchanSection());
