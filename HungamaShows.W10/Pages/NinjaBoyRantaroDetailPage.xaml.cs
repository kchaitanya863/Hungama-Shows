//---------------------------------------------------------------------------
//
// <copyright file="NinjaBoyRantaroDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class NinjaBoyRantaroDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public NinjaBoyRantaroDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new NinjaBoyRantaroSection());
