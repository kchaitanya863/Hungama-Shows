//---------------------------------------------------------------------------
//
// <copyright file="DoraemonListPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DoraemonListPage : Page
    {
        Windows.Storage.ApplicationDataContainer localSettings =
      Windows.Storage.ApplicationData.Current.LocalSettings;
        public ListViewModel ViewModel { get; set; }
        public DoraemonListPage()
        {
			ViewModel = ViewModelFactory.NewList(new DoraemonSection());
        ...
        {
			ShellPage.Current.ShellControl.SelectItem("926a35b5-309c-414b-9a6f-d7e77fde955d");
