//---------------------------------------------------------------------------
//
// <copyright file="KiteretsuDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class KiteretsuDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public KiteretsuDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new KiteretsuSection());
