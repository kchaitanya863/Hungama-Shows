//---------------------------------------------------------------------------
//
// <copyright file="OswaldDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class OswaldDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public OswaldDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new OswaldSection());
