//---------------------------------------------------------------------------
//
// <copyright file="DoraemonDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DoraemonDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DoraemonDetailPage()
        {
            ViewModel = ViewModelFactory.NewDetail(new DoraemonSection());
