...
{
    public class DoraemonSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public DoraemonSection()
		{
		...
		public override async Task<IEnumerable<YouTubeSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            var config = new YouTubeDataConfig
            {
                ...
                Query = @"doraemon full episodes in " + Windows.Storage.ApplicationData.Current.LocalSettings.Values["Language"],
            };
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.DoraemonListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.DoraemonDetailPage>(true);
                    }
                };
            }
        }
