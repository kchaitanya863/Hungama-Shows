...
{
    public class HagemaruSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public HagemaruSection()
		{
		...
		public override async Task<IEnumerable<YouTubeSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            var config = new YouTubeDataConfig
            {
                ...
                Query = @"hagemaru full episodes in " + Windows.Storage.ApplicationData.Current.LocalSettings.Values["Language"],
            };
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.HagemaruListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.HagemaruDetailPage>(true);
                    }
                };
            }
        }
