...
{
    public class NinjaBoyRantaroSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public NinjaBoyRantaroSection()
		{
		...
		public override async Task<IEnumerable<YouTubeSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            var config = new YouTubeDataConfig
            {
                ...
                Query = @"ninja boy rantaro full episodes in " + Windows.Storage.ApplicationData.Current.LocalSettings.Values["Language"],
            };
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.NinjaBoyRantaroListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.NinjaBoyRantaroDetailPage>(true);
                    }
                };
            }
        }
