...
{
    public class ShinchanSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public ShinchanSection()
		{
		...
		public override async Task<IEnumerable<YouTubeSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            var config = new YouTubeDataConfig
            {
                ...
                Query = @"shinchan full episodes in " + Windows.Storage.ApplicationData.Current.LocalSettings.Values["Language"],
            };
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.ShinchanListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.ShinchanDetailPage>(true);
                    }
                };
            }
        }
