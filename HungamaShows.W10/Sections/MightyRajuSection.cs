...
{
    public class MightyRajuSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public MightyRajuSection()
		{
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.MightyRajuListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.MightyRajuDetailPage>(true);
                    }
                };
            }
        }
