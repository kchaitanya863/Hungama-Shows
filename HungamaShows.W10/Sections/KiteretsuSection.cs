...
{
    public class KiteretsuSection : Section<YouTubeSchema>
    {
		private YouTubeDataProvider _dataProvider;
		
		public KiteretsuSection()
		{
		...
		public override async Task<IEnumerable<YouTubeSchema>> GetDataAsync(SchemaBase connectedItem = null)
        {
            var config = new YouTubeDataConfig
            {
                ...
                Query = @"kiteretsu full episodes in " + 
                Windows.Storage.ApplicationData.Current.LocalSettings.Values["Language"],
            };
        ...
        public override ListPageConfig<YouTubeSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<YouTubeSchema>
                {
                    ...
                    Page = typeof(Pages.KiteretsuListPage),
                    ...
                    {
						return NavInfo.FromPage<Pages.KiteretsuDetailPage>(true);
                    }
                };
            }
        }
